...
```sh
  cd my-folder
  git clone git@github.com:HenaryKhuraijam/hello-rails-back-end.git
```
...
If you like this project please give it a star on [GitHub](git@github.com:HenaryKhuraijam/hello-rails-back-end.git).
